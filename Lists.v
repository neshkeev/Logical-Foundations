...
Fixpoint subset (s1:bag) (s2:bag) : bool :=
  ...
  | [], s => true
  | s, [] => false
  | h1::t1, s => match (count h1 s) with
                | 0 => false
                | _ => subset t1 (remove_one h1 s)
                end
  end.
...
Theorem ref_injective : forall l1 l2 : natlist,
    rev l1 = rev l2 -> l1 = l2.
Proof.
  intros l1 l2.
  intros H.
...
Proof.
  intros x. destruct x. simpl. rewrite <- beq_nat_refl. reflexivity.
Qed.
(** [] *)
