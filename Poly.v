...
Proof.
  intros X l1 l2.
  induction l1 as [|n l1' IHl].
  - (* l1 = nil *) rewrite -> app_nil_r. reflexivity.
  - (* l1 = n :: l1' *) simpl. rewrite -> IHl. rewrite <- app_assoc.
    reflexivity.
Qed.
...
Proof.
  ...
  induction l as [|n l' IHl].
  - (* l = nil *) reflexivity.
  - (* l = n :: l' *) simpl. rewrite -> rev_app_distr, IHl.
    reflexivity.
Qed.
(** [] *)
...
Definition filter_even_gt7 (l : list nat) : list nat
  := filter (fun n => andb (evenb n) (negb (leb n 6))) l.
